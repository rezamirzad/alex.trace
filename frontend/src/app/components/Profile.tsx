    ...
    <section className="relative">
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
        <div className="lg:w-3/5 w-full flex flex-col">
          {/* Mobile-First Download Button: Positioned above the text on small screens */}
          <div className="mb-8 lg:hidden">
            <a
              href={`/${t.hero.cvFilename}`}
              download={t.hero.cvFilename}
              className="inline-flex items-center gap-3 px-6 py-3 border border-zinc-200 text-[9px] font-black uppercase tracking-[0.2em] text-zinc-900 hover:bg-zinc-50 transition-all"
            >
          ...
          {/* Desktop Download Button: Hidden on mobile, original style for large screens */}
          <div className="mt-12 hidden lg:block">
            <a
              href={`/${t.hero.cvFilename}`}
              download={t.hero.cvFilename}
              className="text-[10px] font-black uppercase tracking-[0.2em] px-10 py-5 bg-black text-white hover:bg-blue-600 transition-all shadow-xl flex items-center gap-4 inline-flex"
            >
              {t.buttons.downloadCv}
